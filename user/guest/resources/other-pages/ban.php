                ...
                <div class="card shadow">
                    <div class="card-body text-center">
                        <div class="lottie-animation mb-4">
                            <lottie-player 
                                src="https://lottie.host/71c7ff93-d15c-496a-b57c-962e1e520225/TWOgNLybfI.json" 
                        ...
                        <h1 class="text-danger mb-4">Account Banned!</h1>
                        <p class="lead">We're sorry, <?php echo htmlspecialchars($username); ?>, but your account has been reviewed and is permanently banned.</p>
                        <div class="ban-details p-3 mb-4 rounded">
                            <p class="mb-2"><strong>Reason:</strong> <?php echo htmlspecialchars($banReason); ?></p>
                            <p class="mb-0"><strong>Expiration Date:</strong> No Expiry</p>
                        </div>
