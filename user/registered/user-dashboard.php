...
<head>
    ...
    <meta name="description" content="Welcome to the KeNHAVATE User Dashboard. Manage your ideas, track submissions, and engage with challenges to shape Kenya's highways. Collaborate with others, view your challenge rankings, and showcase your awards for outstanding contributions.">    <!-- Bootstrap -->
    ...
    <div class="home-content container-fluid d-flex justify-content-center p-0 m-0">
        <div class="row w-100">
            <nav id="sidebar" class="col-lg-3 d-flex flex-column sidebar">
                <?php include './resources/navbar/registered-nav.php'; ?>
            </nav>
